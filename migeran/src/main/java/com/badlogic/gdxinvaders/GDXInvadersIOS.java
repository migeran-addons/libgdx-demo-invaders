...
@ObjCClassName("GDXInvadersIOS")
public class GDXInvadersIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new Invaders(), config);
	...
	public static void main(String[] args) {
		UIKit.UIApplicationMain(0, null, null,
				GDXInvadersIOS.class.getSimpleName());
	}
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native GDXInvadersIOS alloc();

	@Generated("NatJ")
	protected GDXInvadersIOS(Pointer peer) {
		super(peer);
	}
	
	@Selector("init")
	public GDXInvadersIOS init() {
		super.init();
		return this;
	}
